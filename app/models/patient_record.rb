...
class PatientRecord < ApplicationRecord
  ...
  enumerize :resting_electrocardiographic_results,
            in: {normal: 0, stt_wave_abnormality: 1, left_ventricular_hypertrophy: 2}, predicates: true, scope: true
  enumerize :slope, in: {upsloping: 1, flat: 2, downsloping: 3}, predicates: true, scope: true
